...
#所有灵魂篝火被熄灭后
execute if block -281 -26 60 crimson_stem if block -275 -48 31 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="east"] if block -314 -38 60 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="west"] if block -281 -30 89 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="east"] run function lib/modify_data/states/timeline/enable_time_lapse
execute if block -281 -26 60 crimson_stem if block -275 -48 31 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="east"] if block -314 -38 60 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="west"] if block -281 -30 89 soul_campfire["extinguished"=true,"minecraft:cardinal_direction"="east"] run function lib/utils/start_dialogue
...
#所有灵魂篝火被点燃后
execute if block -281 -26 60 warped_stem if block -275 -48 31 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="east"] if block -314 -38 60 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="west"] if block -281 -30 89 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="east"] run function lib/modify_data/states/timeline/enable_time_lapse
execute if block -281 -26 60 warped_stem if block -275 -48 31 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="east"] if block -314 -38 60 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="west"] if block -281 -30 89 soul_campfire["extinguished"=false,"minecraft:cardinal_direction"="east"] run function lib/utils/start_dialogue
...
execute if block -270 -30 60 stone_button["button_pressed_bit"=true,"facing_direction"=4] if score 7_fortress_boss data matches 0 run function lib/modify_data/states/timeline/enable_time_lapse
