...
execute if block -279 32 90 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -279 32 90 as @p if entity @s[hasitem=[{item=aw:build1,quantity=10..},{item=aw:build3,quantity=15..}]] run function lib/modify_states/timeline/enable_lock_camera
...
execute if block -300 32 92 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -300 32 92 as @p if entity @s[hasitem={item=aw:build2,quantity=15..}] run function lib/modify_states/timeline/enable_lock_camera
...
execute if block -315 32 92 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -315 32 92 as @p if entity @s[hasitem={item=aw:build3,quantity=10..}] run function lib/modify_states/timeline/enable_lock_camera
...
execute if score timeline active matches 0 if block -276 31 84 air if blocks -290 29 96 -277 29 96 -290 31 96 all if blocks -290 29 93 -287 29 93 -290 31 93 all run function lib/modify_states/timeline/enable_lock_camera
