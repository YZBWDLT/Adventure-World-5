...
#中途退出
execute if block 34 68 114 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/utils/stop_dialogue
execute if block 34 68 114 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/modify_data/states/timeline/disable
...
#胜利判定
execute if score timeline time matches 200.. if block 42 66 114 grass_block if blocks 33 60 103 54 90 124 58 60 103 all run tp @a[x=33,y=60,z=103,dx=21,dy=30,dz=21] 37 67 99 facing 37 67 98
...
execute if block 37 68 93 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/utils/stop_dialogue
execute if block 37 68 93 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/modify_data/states/timeline/disable
