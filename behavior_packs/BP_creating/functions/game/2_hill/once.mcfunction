...
execute if score 2_hill_book data matches 0 if block -287 -23 124 chest if blocks -287 -23 124 -287 -23 124 -287 -23 139 all run function lib/utils/music/queue
...
execute if score 2_hill_key data matches 0 if block -287 -17 97 chest if blocks -287 -17 97 -287 -17 97 -232 -9 179 all run function lib/utils/music/queue
...
execute if block -287 -12 95 stone_button["button_pressed_bit"=true,"facing_direction"=3] run function lib/utils/music/queue
