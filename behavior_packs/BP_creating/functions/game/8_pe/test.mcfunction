...
execute if block -226 -54 -35 stone_button["button_pressed_bit"=true,"facing_direction"=1] if score 8_pe_boss data matches 1 run function lib/modify_states/timeline/enable_lock_camera
