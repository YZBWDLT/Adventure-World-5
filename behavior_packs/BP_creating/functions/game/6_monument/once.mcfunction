...
execute if score 6_monument_book data matches 0 if block -127 -48 172 chest if blocks -127 -48 172 -127 -48 172 -127 -61 172 all run function lib/utils/music/queue
...
execute if score 6_monument_key data matches 0 if block -98 -58 131 chest if blocks -98 -58 131 -98 -58 131 -232 -9 179 all run function lib/utils/music/queue
...
execute if score 6_monument_boss data matches 0 if block -122 -47 177 stone_button["button_pressed_bit"=true,"facing_direction"=2] run function lib/utils/music/replay
...
execute if score 6_monument_boss data matches 1 if entity @a[x=-163,y=-52,z=143,dx=10,dy=10,dz=10] run function lib/utils/music/queue
...
execute if entity @a[x=-157.5,y=-48,z=157.5,r=1] run function lib/utils/music/replay
...
execute if score 6_monument_boss data matches 2..5 if block -122 -47 177 stone_button["button_pressed_bit"=true,"facing_direction"=2] run function lib/utils/music/replay
...
execute if score 6_monument_boss data matches 5 if entity @a[x=-169,y=-57,z=161,dx=16,dy=12,dz=16] if block -161 -58 169 sea_lantern unless entity @e[type=drowned,x=-169,y=-57,z=161,dx=16,dy=12,dz=16] run function lib/utils/music/queue
...
execute if score 6_monument_boss data matches ..6 if entity @a[x=-160.5,y=-57,z=185.5,r=1] run function lib/utils/music/replay
