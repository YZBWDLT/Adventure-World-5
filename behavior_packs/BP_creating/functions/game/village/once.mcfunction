...
execute if score flintAndSteel itemState matches 2 if score client data matches 0 if block -190 29 130 chest if blocks -190 29 130 -190 29 130 -192 29 130 all run function game/village/events/get_flint_and_steel
execute if score flintAndSteel itemState matches 2 if score client data matches 1 if entity @a[hasitem={item=flint_and_steel}] run function game/village/events/get_flint_and_steel
...
execute if score progress data matches 2 if score village_goto_plain data matches 0 if entity @a[x=-200,y=31,z=108,r=10] run function lib/utils/start_dialogue
...
execute if block -220 32 178 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -220 32 178 as @p if entity @s[hasitem=[{item=aw:build1,quantity=10..},{item=aw:build2,quantity=15..}]] run function lib/utils/start_dialogue
...
execute if block -192 32 154 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -192 32 154 as @p if entity @s[hasitem={item=aw:build1,quantity=25..}] run function lib/utils/start_dialogue
...
execute if block -155 32 154 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -155 32 154 as @p if entity @s[hasitem=[{item=aw:build1,quantity=15..},{item=aw:build3,quantity=10..}]] run function lib/utils/start_dialogue
...
execute if block -175 32 152 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -175 32 152 as @p if entity @s[hasitem={item=aw:build3,quantity=25..}] run function lib/utils/start_dialogue
...
execute if block -220 32 114 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -220 32 114 as @p if entity @s[hasitem=[{item=aw:build1,quantity=10..},{item=aw:build2,quantity=5..}]] run function lib/utils/start_dialogue
...
execute if block -204 32 121 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/utils/start_dialogue
...
execute if block -243 32 114 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -243 32 114 as @p if entity @s[hasitem={item=aw:build2,quantity=25..}] run function lib/utils/start_dialogue
...
execute if block -168 32 176 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -168 32 176 as @p if entity @s[hasitem=[{item=aw:build1,quantity=10..},{item=aw:build2,quantity=10..},{item=aw:build3,quantity=10..}]] run function lib/utils/start_dialogue
...
execute if block -172 32 130 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -172 32 130 as @p if entity @s[hasitem=[{item=aw:build1,quantity=15..},{item=aw:build2,quantity=15..}]] run function lib/utils/start_dialogue
...
execute if block -234 -25 182 quartz_block if block -234 -23 182 stone_button["button_pressed_bit"=true,"facing_direction"=1] if entity @a[hasitem={item=blue_ice}] run function lib/utils/start_dialogue
...
execute if block -243 32 139 stone_button["button_pressed_bit"=true,"facing_direction"=1] if entity @p[hasitem={item=obsidian,quantity=16..}] run function lib/utils/start_dialogue
...
#和王予凡在沙滩聊天
execute if score flintAndSteel itemState matches 1 if entity @a[x=-282,y=31,z=178,dx=20,dy=2,dz=13] run scoreboard players set timeline active 34
execute if score flintAndSteel itemState matches 1 if entity @a[x=-282,y=31,z=178,dx=20,dy=2,dz=13] run function lib/modify_states/timeline/enable_time_lapse
execute if score flintAndSteel itemState matches 1 if entity @a[x=-282,y=31,z=178,dx=20,dy=2,dz=13] run function lib/utils/start_dialogue
execute if score flintAndSteel itemState matches 1 if entity @a[x=-282,y=31,z=178,dx=20,dy=2,dz=13] run scoreboard players set flintAndSteel itemState 2
