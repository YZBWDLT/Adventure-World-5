...
#退出跑酷
execute if block -63 68 183 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/modify_states/timeline/disable
...
execute if block -63 68 183 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function music/replay
...
execute if block -17 75 151 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function lib/modify_states/timeline/disable
...
execute if block -17 75 151 stone_button["button_pressed_bit"=true,"facing_direction"=1] run function music/play
