...
execute unless entity @s[hasitem={item=aw:build1}] run scoreboard players set could_brew_potion data 0
...
# 如果材料充足，获得药水，清除木材和空瓶子
execute if score could_brew_potion data matches 1 run clear @s aw:build1 0 1
