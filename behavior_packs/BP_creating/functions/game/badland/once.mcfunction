...
execute unless block -83 64 -26 light_blue_glazed_terracotta if block -91 65 -42 campfire["extinguished"=false,"minecraft:cardinal_direction"="north"] run function music/play
...
execute if block -78 16 17 hardened_clay if blocks -88 2 5 -78 9 15 -78 16 5 all run function music/play
...
execute if score bottle4 data matches 0 if block -97 79 -50 chest if blocks -97 79 -50 -97 79 -50 -232 -9 179 all run function music/play
