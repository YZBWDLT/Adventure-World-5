...
execute if block -99 17 10 stone_button["button_pressed_bit"=true,"facing_direction"=1] positioned -99 17 10 as @p if entity @s[hasitem=[{item=aw:build2,quantity=5..},{item=aw:build3,quantity=20..}]] run function lib/modify_data/states/timeline/enable_time_lapse
