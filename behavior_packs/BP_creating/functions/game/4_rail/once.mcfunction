...
execute if score 4_rail_book data matches 0 if block -139 -46 -56 chest if blocks -139 -46 -56 -139 -46 -56 -139 -48 -56 all run function music/play
...
execute if score 4_rail_key data matches 0 if block -122 -42 -11 chest if blocks -122 -42 -11 -122 -42 -11 -234 -9 179 all run function music/play
...
execute if score 4_rail_boss data matches 0 if block -192 -37 -12 stone_button["button_pressed_bit"=true,"facing_direction"=5] run function music/replay
...
execute if score 4_rail_boss data matches 1 if block -173 -20 -36 smooth_stone unless entity @e[type=chest_minecart] run function music/replay
...
execute if score 4_rail_boss data matches 1 if entity @e[type=chest_minecart,x=-157.5,y=-33,z=-14.5,r=1] run function music/play
...
execute if score 4_rail_boss data matches 2 if entity @a[x=-152.5,y=-33.00,z=-3.5,r=1] run function lib/modify_states/timeline/enable_lock_camera
