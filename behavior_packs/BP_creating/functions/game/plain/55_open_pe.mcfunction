...
execute if score timeline time matches 830 run function lib/utils/stop_dialogue
execute if score timeline time matches 830 run function lib/modify_data/states/timeline/disable