...
#村庄后山点蜡烛显示
execute if block -141 48 -64 white_candle["candles"=0,"lit"=true] if block -141 31 -21 grass run setblock -141 31 -21 redstone_block
execute if block -175 50 -58 orange_candle["candles"=0,"lit"=true] if block -141 31 -20 grass run setblock -141 31 -20 redstone_block
execute if block -153 50 -60 light_gray_candle["candles"=0,"lit"=true] if block -141 31 -19 grass run setblock -141 31 -19 redstone_block
execute if block -166 41 -53 black_candle["candles"=0,"lit"=true] if block -141 31 -18 grass run setblock -141 31 -18 redstone_block
execute if block -141 43 -34 yellow_candle["candles"=0,"lit"=true] if block -141 31 -17 grass run setblock -141 31 -17 redstone_block
...
execute if block -154 31 -6 pumpkin if block -141 48 -64 white_candle["candles"=0,"lit"=true] if block -175 50 -58 orange_candle["candles"=0,"lit"=true] if block -153 50 -60 light_gray_candle["candles"=0,"lit"=true] if block -166 41 -53 black_candle["candles"=0,"lit"=true] if block -141 43 -34 yellow_candle["candles"=0,"lit"=true] run function music/play
