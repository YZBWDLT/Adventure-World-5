...
execute if score timeline time matches 80 run function lib/modify_states/timeline/disable 
...
execute if score timeline time matches 160 run function lib/modify_states/timeline/disable 
...
execute if score timeline time matches 440 run function lib/modify_states/timeline/disable 