...
## 道具状态
scoreboard players set sword itemState 0
scoreboard players set pickaxe itemState 0
scoreboard players set firstBlock itemState 0
scoreboard players set windPearl itemState 0
scoreboard players set secondBlock itemState 0
scoreboard players set shell itemState 0
scoreboard players set pumpkin itemState 0
scoreboard players set bow itemState 0
scoreboard players set quiver itemState 0
scoreboard players set thirdBlock itemState 0
scoreboard players set flintAndSteel itemState 0
scoreboard players set waterGun itemState 0
scoreboard players set emeraldPickaxe itemState 0
scoreboard players set schellonBrush itemState 0
